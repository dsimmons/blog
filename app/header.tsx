  ...
  return (
    <header className="mb-5 flex items-center md:mb-10">
      ...
      <nav className="flex grow items-center justify-end gap-1 font-mono text-xs md:gap-3">
        ...
        <a
          href="https://twitter.com/simmons_dan"
          target="_blank"
          className="-mr-2 inline-flex items-center whitespace-nowrap rounded-sm p-2 transition-[background-color] hover:bg-gray-200 active:bg-gray-300 dark:hover:bg-[#313131] dark:active:bg-[#242424]"
        >
